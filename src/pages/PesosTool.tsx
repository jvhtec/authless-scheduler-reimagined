...
const PesosTool = () => {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      // Use job title for file name and project name
      const jobTitle = selectedJob.title.trim() || 'Unnamed Job';
      const pdfBlob = await exportToPDF(jobTitle, tables, 'weight', { totalSystemWeight }, {
        // Optional styling options for better table appearance in PDF
        tableStyles: {
