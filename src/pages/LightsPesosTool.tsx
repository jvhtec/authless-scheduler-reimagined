...
const lightsComponentDatabase = [
  { id: 1, name: 'MAC Aura XB', weight: 6.5 },
  { id: 2, name: 'MAC Quantum', weight: 23.6 },
  { id: 3, name: 'MAC Viper', weight: 37.2 },
  { id: 4, name: 'Source Four LED', weight: 7.7 },
  { id: 5, name: 'Box Truss 30cm', weight: 8.5 },
  { id: 6, name: 'Box Truss 40cm', weight: 12.3 },
  { id: 7, name: 'CM Lodestar 1T', weight: 46.0 },
  { id: 8, name: 'CM Lodestar 2T', weight: 67.0 }
];
